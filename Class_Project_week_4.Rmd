...
## Summary and Conclusions
        ...
        The random Forest model out performed the Classification Tree and Pruned tree models by leaps and bounds with an accuracy over 99% and an estimated out of sample error of  0.0008932247 with this data set it is the best model selection. The model was able to predict all outcomes of the test data accurately. Predictions from Model 3: B  A  B  A  A  E  D  B  A   A   B   C   B   A   E   E   A   B   B   B
